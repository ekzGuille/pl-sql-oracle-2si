...
-- TABLA CLIENTES-CUENTAS
DROP TABLE CLIENTE_CUENTA CASCADE CONSTRAINTS;
CREATE TABLE CLIENTE_CUENTA(
  NIF         VARCHAR2(10) NOT NULL,
  NUM_CTA     NUMBER(10),
  CONSTRAINT PK_CLIENTE_CUENTA PRIMARY KEY (NIF,COD_BANCO,NUM_CTA),
  CONSTRAINT FK_CLIENTE_CUENTA FOREIGN KEY (NUM_CTA) REFERENCES CUENTA (NUM_CTA)
);

GRANT SELECT, INSERT, UPDATE, DELETE ON CLIENTE_CUENTA TO GUILLERMO;
