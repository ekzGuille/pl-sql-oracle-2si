  ...
  BEFORE INSERT OR UPDATE OR DELETE
    ...
    EXCEPTION 
      ...
      WHEN e_POBLACION_NO_EXISTE THEN
        DBMS_OUTPUT.PUT_LINE('HA DE INTRODUCIR UNA POBLACION DE LAS EXISTENTES');
END;
/
...
CREATE OR REPLACE TRIGGER SUCURSALES_BEFORE_TR
  ...
  EXCEPTION 
    ...
    WHEN e_LOCALIDAD_NO_EXISTE THEN
        DBMS_OUTPUT.PUT_LINE('HA DE INTRODUCIR UNA LOCALIDAD DE LAS EXISTENTES');
END;
/
...
CREATE OR REPLACE TRIGGER MOVIMIENTOS_BEFORE_TR
  ...
  EXCEPTION 
    WHEN NO_DATA_FOUND THEN
      DBMS_OUTPUT.PUT_LINE('EL COD_BANCO, COD_SUCUR Y/O NUM_CTA INTRODUCIDO NO EXISTE');
    WHEN e_PK_COD_BAN_SUCUR_NCTA_EXISTE THEN
      DBMS_OUTPUT.PUT_LINE('EL COD_BANCO, COD_SUCUR Y/O NUM_CTA INTRODUCIDO EXISTE, NO SE PUEDEN SOBRESCRIBIR');
    WHEN e_MOV_FUTURO THEN 
      DBMS_OUTPUT.PUT_LINE('NO SE PUEDEN REALIZAR MOVIMIENTOS A FUTURO');
    WHEN e_POBLACION_DISTINTA THEN 
      DBMS_OUTPUT.PUT_LINE('NO SE HACER MOVIMIENTOS A CUENTAS CON POBLACION DISTINTA A LA EXISTENTE');
END;
/
